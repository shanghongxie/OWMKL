function [Sigma,Alpsup,w0,pos,CostNew] = mklwsvmupdate(K,Sigma,pos,Alpsup,w0,c, yapp, Rweightapp, GradNew,CostNew,option)
...
while costmax<costmin;
            ...
            [costmax,Alpsupaux,w0aux,posaux] = costwsvmclassls(K,stepmax,desc,SigmaNew,pos,Alpsup,c,yapp,Rweightapp,option) ;
...
while (stepmax-stepmin)>option.goldensearch_deltmax*(abs(deltmax));
    ...
    stepmedl = stepmin+(stepmedr-stepmin)/gold;                     
            ...
            [costmedr,Alpsupr,w0r,posr] = costwsvmclassls(K,stepmedr,desc,SigmaNew,pos,Alpsup,c,yapp,Rweightapp,option) ;
            [costmedl,Alpsupl,w01,posl] = costwsvmclassls(K,stepmedl,desc,SigmaNew,posr,Alpsupr,c,yapp,Rweightapp,option) ;
